  ...
  <div class="yt-urls">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-3xl font-bold text-gray-800">
        ...
        <span class="text-lg font-normal text-gray-500">({{ ytUrlStore.totalCount }})</span>
      </h1>
      <button 
    ...
    <!-- Empty State -->
    <div v-else-if="!ytUrlStore.ytUrls || ytUrlStore.ytUrls.length === 0" class="text-center py-12">
    ...
    <template v-else>
          ...
          <div class="p-4">
            ...
            <div class="flex items-center justify-between pt-3 border-t">
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span class="text-sm text-gray-600">Watched</span>
              </label>
      ...
      <!-- Pagination -->
      <Pagination
        :current-page="ytUrlStore.currentPage"
        :total-items="ytUrlStore.totalCount"
        :per-page="ytUrlStore.perPage"
    ...
    <ConfirmModal
      ...
      type="danger"
      title="Delete URL?"
      :message="ytUrlToDelete ? `Are you sure you want to delete this URL? This action cannot be undone.` : 'This action cannot be undone.'"
      confirm-text="Delete"
      cancel-text="Keep it"
    />
